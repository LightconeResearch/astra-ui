...
import { locateRecord, type InventoryIndex } from '../data/inventory-index.js';
import { findPaper, paperMetadataFor, type InventoryPaper, type InventoryPaperMetadataMap } from '../data/papers.js';
import { isInsight, isVisualOutput, recordTitle } from '../data/records.js';
import { decisionInsights, findingEvidence, informedDecisions, outputRelations } from '../data/relations.js';
import { useLabels } from '../lib/labels.js';
import type { ArtifactRenderer } from '../ui/artifact-preview.js';
import { DetailDialog, type DetailDialogProps, type DialogLayout } from '../ui/dialog.js';
import type { SurfaceKind } from '../ui/kind.js';
