/** Record details and dialogs, typed with the SDK's Resolved* values. */
...
export type { InsightTriggerProps } from './insight-trigger.js';
export { PaperDetail, PaperDialog, PaperDialogActions } from './paper-detail.js';
export type { PaperDetailProps, PaperDialogProps, PaperRenderOptions, PaperRenderer } from './paper-detail.js';
