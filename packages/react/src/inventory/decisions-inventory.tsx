...
export interface DecisionsInventoryProps extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> {
...
export const DecisionsInventory = forwardRef<HTMLDivElement, DecisionsInventoryProps>(function DecisionsInventory({
  analysis,
  tagLabels = {},
  ...
  if (!records.length) {
    return <EmptyState {...props} ref={ref} data-slot="decisions-inventory" className={className}>{labels.empty.decisions}</EmptyState>;
  }
